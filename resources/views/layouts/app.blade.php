        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    @php
                        $facturacionOpen = request()->routeIs('facturas.*')
                            || request()->routeIs('notas-credito.*')
                            || request()->routeIs('comunicaciones-baja.*')
                            || request()->routeIs('resumen-boletas.*');
                    @endphp
                    <li class="nav-item {{ $facturacionOpen ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ $facturacionOpen ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('facturas.index') }}"
                                   class="nav-link {{ request()->routeIs('facturas.*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i><p>Facturas / Boletas</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('notas-credito.index') }}"
                                   class="nav-link {{ request()->routeIs('notas-credito.*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon text-warning"></i>
                                    <p>Notas de Crédito</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('comunicaciones-baja.index') }}"
                                   class="nav-link {{ request()->routeIs('comunicaciones-baja.*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon text-danger"></i>
                                    <p>Comunicaciones de Baja</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('resumen-boletas.index') }}"
                                   class="nav-link {{ request()->routeIs('resumen-boletas.*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon text-info"></i>
                                    <p>Resumen Diario Boletas</p>
                                </a>
                            </li>
                        </ul>
                    </li>
