    ...
    <div class="card-body py-2">
        <form method="GET" class="form-inline">
            ...
            <div class="ml-auto pl-3">
                <a href="{{ route('reportes.huespedes.exportar', ['desde' => $desde->format('Y-m-d'), 'hasta' => $hasta->format('Y-m-d'), 'formato' => 'pdf']) }}"
                   class="btn btn-sm btn-danger mr-1" target="_blank">
                    <i class="fas fa-file-pdf mr-1"></i>PDF
                </a>
                <a href="{{ route('reportes.huespedes.exportar', ['desde' => $desde->format('Y-m-d'), 'hasta' => $hasta->format('Y-m-d'), 'formato' => 'excel']) }}"
