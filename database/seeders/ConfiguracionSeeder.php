...
class ConfiguracionSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            ['clave' => 'sunat_sol_usuario',        'valor' => '',             'grupo' => 'sunat', 'tipo' => 'text',     'descripcion' => 'Usuario SOL secundario para facturación electrónica'],
            ['clave' => 'sunat_sol_clave',          'valor' => '',             'grupo' => 'sunat', 'tipo' => 'password', 'descripcion' => 'Clave SOL del usuario secundario'],
            ['clave' => 'sunat_ambiente',           'valor' => 'beta',         'grupo' => 'sunat', 'tipo' => 'select',   'descripcion' => 'Ambiente SUNAT: beta (pruebas) o produccion'],
            ['clave' => 'sunat_certificado_path',   'valor' => '',             'grupo' => 'sunat', 'tipo' => 'file',     'descripcion' => 'Ruta al certificado digital en storage/app'],
            ['clave' => 'sunat_certificado_clave',  'valor' => '',             'grupo' => 'sunat', 'tipo' => 'password', 'descripcion' => 'Contraseña del certificado .p12'],
            ['clave' => 'sunat_ubigeo',             'valor' => '150101',       'grupo' => 'sunat', 'tipo' => 'text',     'descripcion' => 'Código ubigeo INEI de 6 dígitos (dpto+prov+dist)'],
            ['clave' => 'sunat_departamento',       'valor' => 'LIMA',         'grupo' => 'sunat', 'tipo' => 'text',     'descripcion' => 'Departamento para comprobantes SUNAT'],
            ['clave' => 'sunat_provincia',          'valor' => 'LIMA',         'grupo' => 'sunat', 'tipo' => 'text',     'descripcion' => 'Provincia para comprobantes SUNAT'],
            ['clave' => 'sunat_distrito',           'valor' => 'LIMA',         'grupo' => 'sunat', 'tipo' => 'text',     'descripcion' => 'Distrito para comprobantes SUNAT'],
        ];
