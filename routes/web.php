...
use App\Http\Controllers\ResumenBoletasController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/facturas/{factura}/sunat/preparar', [FacturaController::class, 'prepararSunat'])->name('facturas.sunat.preparar');
    Route::post('/facturas/{factura}/sunat/emitir',   [FacturaController::class, 'emitirSunat'])->name('facturas.sunat.emitir');
    Route::get('/facturas/{factura}/sunat/xml',       [FacturaController::class, 'descargarXml'])->name('facturas.sunat.xml');
    Route::get('/facturas/{factura}/sunat/cdr',       [FacturaController::class, 'descargarCdr'])->name('facturas.sunat.cdr');
    ...
    Route::post('/notas-credito/{notaCredito}/emitir',        [NotaCreditoController::class, 'emitir'])->name('notas-credito.emitir');
    Route::get('/notas-credito/{notaCredito}/xml',            [NotaCreditoController::class, 'descargarXml'])->name('notas-credito.xml');
    Route::get('/notas-credito/{notaCredito}/cdr',            [NotaCreditoController::class, 'descargarCdr'])->name('notas-credito.cdr');

    // ── Comunicación de Baja (Voided Documents) ─────────────────
    Route::get('/comunicaciones-baja',                                [ComunicacionBajaController::class, 'index'])->name('comunicaciones-baja.index');
    Route::get('/comunicaciones-baja/crear',                          [ComunicacionBajaController::class, 'create'])->name('comunicaciones-baja.create');
    Route::post('/comunicaciones-baja',                               [ComunicacionBajaController::class, 'store'])->name('comunicaciones-baja.store');
    Route::get('/comunicaciones-baja/{comunicacionBaja}',             [ComunicacionBajaController::class, 'show'])->name('comunicaciones-baja.show');
    Route::post('/comunicaciones-baja/{comunicacionBaja}/emitir',     [ComunicacionBajaController::class, 'emitir'])->name('comunicaciones-baja.emitir');
    Route::post('/comunicaciones-baja/{comunicacionBaja}/consultar',  [ComunicacionBajaController::class, 'consultarTicket'])->name('comunicaciones-baja.consultar');
    Route::get('/comunicaciones-baja/{comunicacionBaja}/xml',         [ComunicacionBajaController::class, 'descargarXml'])->name('comunicaciones-baja.xml');
    Route::get('/comunicaciones-baja/{comunicacionBaja}/cdr',         [ComunicacionBajaController::class, 'descargarCdr'])->name('comunicaciones-baja.cdr');

    // ── Resumen Diario de Boletas (RC) ───────────────────────────
    Route::get('/resumen-boletas',                              [ResumenBoletasController::class, 'index'])->name('resumen-boletas.index');
    Route::get('/resumen-boletas/crear',                        [ResumenBoletasController::class, 'create'])->name('resumen-boletas.create');
    Route::post('/resumen-boletas',                             [ResumenBoletasController::class, 'store'])->name('resumen-boletas.store');
    Route::get('/resumen-boletas/{resumenBoletas}',             [ResumenBoletasController::class, 'show'])->name('resumen-boletas.show');
    Route::post('/resumen-boletas/{resumenBoletas}/emitir',     [ResumenBoletasController::class, 'emitir'])->name('resumen-boletas.emitir');
    Route::post('/resumen-boletas/{resumenBoletas}/consultar',  [ResumenBoletasController::class, 'consultarTicket'])->name('resumen-boletas.consultar');
    Route::get('/resumen-boletas/{resumenBoletas}/xml',         [ResumenBoletasController::class, 'descargarXml'])->name('resumen-boletas.xml');
    Route::get('/resumen-boletas/{resumenBoletas}/cdr',         [ResumenBoletasController::class, 'descargarCdr'])->name('resumen-boletas.cdr');
    ...
    Route::post('/housekeeping/{habitacion}/estado',      [HousekeepingController::class, 'actualizarEstado'])->name('housekeeping.estado');
    Route::post('/housekeeping/marcar-sucias',            [HousekeepingController::class, 'marcarTodasSucias'])->name('housekeeping.marcar-sucias');

    // ── Tarifas por temporada ──────────────────────────────────
    Route::resource('/tarifas', TarifaTemporadaController::class)->except(['show']);
    Route::post('/tarifas/{tarifa}/toggle', [TarifaTemporadaController::class, 'toggle'])->name('tarifas.toggle');
    ...
    Route::get('/reportes/ocupacion/exportar',  [ReporteController::class, 'exportarOcupacion'])->name('reportes.ocupacion.exportar');
    Route::get('/reportes/ingresos/exportar',   [ReporteController::class, 'exportarIngresos'])->name('reportes.ingresos.exportar');
    Route::get('/reportes/huespedes/exportar',  [ReporteController::class, 'exportarHuespedes'])->name('reportes.huespedes.exportar');
